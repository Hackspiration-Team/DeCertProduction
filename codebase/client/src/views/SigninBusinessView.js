...
class SigninBusinessView extends React.Component {
  static get Controller() {
    if (Controller) return Controller;

    try {
      Controller = require("..controllers/SigninBusinessController");
      Controller = Controller.default || Controller;

      return Controller;
    } catch (e) {
      if (e.code == "MODULE_NOT_FOUND") {
        Controller = SigninBusinessView;
  ...
  componentDidMount() {
    ...
    htmlEl.dataset["wfPage"] = "626642e466bcd674f1f76c0b";
  ...
  render() {
    const proxies =
      SigninBusinessView.Controller !== SigninBusinessView
    ...
    return (
      <span>
        <style
          ...
          @media (max-width:991px) and (min-width:768px) {html.w-mod-js:not(.w-mod-ix) [data-w-id=\"0b069c33-79c3-fd32-95a7-9a6704bba985\"] {-webkit-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);}}@media (max-width:767px) and (min-width:480px) {html.w-mod-js:not(.w-mod-ix) [data-w-id=\"0b069c33-79c3-fd32-95a7-9a6704bba985\"] {-webkit-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);}}@media (max-width:479px) {html.w-mod-js:not(.w-mod-ix) [data-w-id=\"0b069c33-79c3-fd32-95a7-9a6704bba985\"] {-webkit-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, -105%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);}}
        `,
          }}
        />
              ...
              <div className="af-class-navbar">
                <div className="af-class-page-padding af-class-is-mobile">
                  <div className="af-class-container-nav-bar af-class-colour--ffffff af-class-nav-padding">
                    ...
                    <nav
                      data-w-id="0b069c33-79c3-fd32-95a7-9a6704bba985"
                    ...
                    >
                      ...
                      >
                        <div className="af-class-primary-btn-mob w-dropdown-toggle">
                          <div className="w-icon-dropdown-toggle" />
                          <div className="af-class-register-button">Signin</div>
                        </div>
                        <nav className="af-class-dropdown-list w-dropdown-list">
                          <a
                            href="#"
                            className="af-class-dropdown-link w-dropdown-link"
                          >
                            As a student
                          </a>
                          <a
                    ...
                    <div
                      data-w-id="0b069c33-79c3-fd32-95a7-9a6704bba9a6"
