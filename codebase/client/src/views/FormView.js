              ...
              <div className="af-class-navbar">
                <div className="af-class-page-padding af-class-is-mobile">
                  <div className="af-class-container-nav-bar af-class-colour--ffffff af-class-nav-padding">
                    ...
                    <nav
                      data-w-id="9b4bf258-5410-b476-50b2-9d369020948b"
                    ...
                    >
                      ...
                      <a href="#" className="af-class-primary-btn-mob w-button">
                        Log out
                      </a>
                    </nav>
                    <a href="#" className="af-class-primary-btn-nav w-button">
                      Log out
                    </a>
                    <div
                      data-w-id="9b4bf258-5410-b476-50b2-9d369020949c"
